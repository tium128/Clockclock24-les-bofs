...
void setup()
{
  ...
  s_A.setMaxSpeed(24000);
  s_A.setAcceleration(3000);
  s_B.setMaxSpeed(24000);
  s_B.setAcceleration(3000);

  s_C.setMaxSpeed(24000);
  s_C.setAcceleration(3000);
  s_D.setMaxSpeed(24000);
  s_D.setAcceleration(3000);

  s_E.setMaxSpeed(24000);
  s_E.setAcceleration(3000);
  s_F.setMaxSpeed(24000);
  s_F.setAcceleration(3000);
}
